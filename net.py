...
class DFPmodel(torch.nn.Module):
    def __init__(self, room_channels: int, boundary_channels: int, interpolation_size: int = 512,
...
if __name__ == "__main__":
    with torch.no_grad():
        ...
        # attrs = ["features", "rbtrans", "rbconvs", "rbgrs", "rttrans", "rtconvs",
        #          "rtgrs", "ac1s", "ac2s", "ac3s", "xc1s", "xc2s",
        #          "ecs", "rcs", "hs", "vs", "ds", "dfs", "last"]
